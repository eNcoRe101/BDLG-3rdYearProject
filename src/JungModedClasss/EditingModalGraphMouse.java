...
public class EditingModalGraphMouse<V, E> extends AbstractModalGraphMouse
    ...
    /**
     * Creates an instance with the specified rendering context and vertex/edge
     * factories, and with default zoom in/out values of 1.1 and 1/1.1.
     *
    ...
    /**
     * Creates an instance with the specified rendering context and vertex/edge
     * factories, and with the specified zoom in/out values.
     *
     * @param rc the rendering context
     * @param vertexFactory used to construct vertices
     * @param edgeFactory used to construct edges
